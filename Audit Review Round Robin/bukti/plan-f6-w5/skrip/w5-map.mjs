// Inventori W5: petakan setiap langkah generik -> route ISYTIHAR -> sasaran yang ADA pada route itu.
...
const w4 = new Set(man.catalogue.filter((g) => g.wave === 'W5').map((g) => g.guide_id));
