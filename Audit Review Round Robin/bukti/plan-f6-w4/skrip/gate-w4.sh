...
OUT="C:/Users/hakim/AppData/Local/Temp/claude/C--Projek-Coding-Sistem-Pengurusan-Dokumen-Masjid/e88973f3-ecbe-4b56-9c1e-7b82460d73b0/scratchpad"
...
for SHARD in screen workflow tenant-admin-public; do
  ...
  ( cd public && php -d max_execution_time=0 -S 127.0.0.1:8092 \
