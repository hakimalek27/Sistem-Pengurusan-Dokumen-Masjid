...
return [
    ...
    'agenda_mesyuarat' => ['label' => 'Agenda Mesyuarat', 'icon' => 'heroicon-o-list-bullet',
        'core' => ['record_date*', 'sender_name'],
        'fields' => [['name' => 'nama_mesyuarat', 'label' => 'Nama Mesyuarat', 'type' => 'text'], ['name' => 'bilangan', 'label' => 'Bilangan', 'type' => 'text']]],
    'keputusan_mesyuarat' => ['label' => 'Keputusan Mesyuarat', 'icon' => 'heroicon-o-check-circle',
        'core' => ['record_date*', 'sender_name'],
        'fields' => [['name' => 'nama_mesyuarat', 'label' => 'Nama Mesyuarat', 'type' => 'text'], ['name' => 'bilangan', 'label' => 'Bilangan', 'type' => 'text']]],
    'surat_keputusan' => ['label' => 'Surat Keputusan / Kelulusan', 'icon' => 'heroicon-o-document-check',
        'core' => ['record_date*', 'our_ref', 'recipient_name'],
        'fields' => [['name' => 'tarikh_kuatkuasa', 'label' => 'Tarikh Kuat Kuasa', 'type' => 'date']]],
    'polisi' => ['label' => 'Polisi', 'icon' => 'heroicon-o-shield-check',
        'core' => ['record_date*', 'sender_name'],
        'fields' => [['name' => 'versi', 'label' => 'Versi', 'type' => 'text'], ['name' => 'tarikh_semakan', 'label' => 'Tarikh Semakan', 'type' => 'date']]],
    'prosedur' => ['label' => 'Prosedur / SOP', 'icon' => 'heroicon-o-clipboard-document-check',
        'core' => ['record_date*', 'sender_name'],
        'fields' => [['name' => 'versi', 'label' => 'Versi', 'type' => 'text'], ['name' => 'pemilik_proses', 'label' => 'Pemilik Proses', 'type' => 'text']]],
    'pelan' => ['label' => 'Pelan / Lukisan', 'icon' => 'heroicon-o-map',
        'core' => ['record_date*', 'sender_org'],
        'fields' => [['name' => 'versi', 'label' => 'Versi', 'type' => 'text'], ['name' => 'lokasi', 'label' => 'Lokasi Projek', 'type' => 'text']]],
    'bajet' => ['label' => 'Bajet / Anggaran', 'icon' => 'heroicon-o-calculator',
        'core' => ['record_date*', 'our_ref'],
        'fields' => [['name' => 'tahun_kewangan', 'label' => 'Tahun Kewangan', 'type' => 'number'], ['name' => 'jumlah', 'label' => 'Jumlah (RM)', 'type' => 'number']]],
    'pesanan_tempatan' => ['label' => 'Pesanan Tempatan', 'icon' => 'heroicon-o-shopping-cart',
        'core' => ['record_date*', 'our_ref', 'sender_org'],
        'fields' => [['name' => 'no_pesanan', 'label' => 'No. Pesanan', 'type' => 'text'], ['name' => 'jumlah', 'label' => 'Jumlah (RM)', 'type' => 'number']]],
    'penyata_bank' => ['label' => 'Penyata Bank', 'icon' => 'heroicon-o-building-library',
        'core' => ['record_date*', 'sender_org'],
        'fields' => [['name' => 'akaun_akhir', 'label' => 'Empat Digit Akhir Akaun', 'type' => 'text'], ['name' => 'tempoh', 'label' => 'Tempoh Penyata', 'type' => 'text']]],
    'rekod_aset' => ['label' => 'Rekod Aset / Inventori', 'icon' => 'heroicon-o-cube',
        'core' => ['record_date*', 'sender_name'],
        'fields' => [['name' => 'no_aset', 'label' => 'No. Aset', 'type' => 'text'], ['name' => 'lokasi', 'label' => 'Lokasi Aset', 'type' => 'text']]],
    'rekod_perolehan' => ['label' => 'Rekod Perolehan', 'icon' => 'heroicon-o-archive-box',
        'core' => ['record_date*', 'sender_org'],
        'fields' => [['name' => 'kaedah', 'label' => 'Kaedah Perolehan', 'type' => 'select', 'options' => ['sebutharga' => 'Sebut Harga', 'tender' => 'Tender', 'terus' => 'Pembelian Terus']]]],
    'permit_lesen' => ['label' => 'Permit / Lesen', 'icon' => 'heroicon-o-identification',
        'core' => ['record_date*', 'sender_org'],
        'fields' => [['name' => 'no_permit', 'label' => 'No. Permit/Lesen', 'type' => 'text'], ['name' => 'sah_hingga', 'label' => 'Sah Hingga', 'type' => 'date']]],
    'aduan' => ['label' => 'Aduan / Maklum Balas', 'icon' => 'heroicon-o-chat-bubble-left-ellipsis',
        'core' => ['record_date*', 'sender_name', 'recipient_name'],
        'fields' => [['name' => 'kategori', 'label' => 'Kategori', 'type' => 'text'], ['name' => 'status_tindakan', 'label' => 'Status Tindakan', 'type' => 'select', 'options' => ['baru' => 'Baru', 'dalam_tindakan' => 'Dalam Tindakan', 'selesai' => 'Selesai']]]],
    'permohonan' => ['label' => 'Permohonan', 'icon' => 'heroicon-o-inbox-arrow-down',
        'core' => ['record_date*', 'sender_name', 'recipient_name'],
        'fields' => [['name' => 'jenis_permohonan', 'label' => 'Jenis Permohonan', 'type' => 'text'], ['name' => 'status', 'label' => 'Status', 'type' => 'select', 'options' => ['baru' => 'Baru', 'diproses' => 'Diproses', 'selesai' => 'Selesai']]]],
    'audio_video' => ['label' => 'Audio / Video', 'icon' => 'heroicon-o-film',
        'core' => ['record_date*', 'sender_name'],
        'fields' => [['name' => 'nama_program', 'label' => 'Program/Peristiwa', 'type' => 'text'], ['name' => 'tempoh', 'label' => 'Tempoh', 'type' => 'text']]],
    'rekod_kehadiran' => ['label' => 'Rekod Kehadiran', 'icon' => 'heroicon-o-user-group',
        'core' => ['record_date*', 'sender_name'],
        'fields' => [['name' => 'nama_program', 'label' => 'Program/Mesyuarat', 'type' => 'text'], ['name' => 'bilangan_hadir', 'label' => 'Bilangan Hadir', 'type' => 'number']]],
];
