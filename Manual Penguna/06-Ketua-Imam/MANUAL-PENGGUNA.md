# Manual Pengguna Diwan - Ketua Imam

**Versi UI disahkan:** 22 Julai 2026

**Tenant contoh:** MAM (data latihan, bukan production)

**Liputan Chrome:** 13/13 halaman, silang tenant HTTP 404, 10 skrin tindakan tambahan.

Manual ini khusus untuk role **Ketua Imam**. Gambar menggunakan data latihan. Nama, e-mel, nombor telefon dan dokumen sebenar organisasi tidak patut dimasukkan ke manual.

## 1. Skop dan had role

**Tanggungjawab:** Membaca rekod/fail yang dibenarkan serta menerima, membalas dan menutup tindakan minit.

**Dibenarkan:** Rekod, fail dan minit.

**Had penting:** Tidak mengubah metadata, membuat keputusan kelulusan, mengurus storan, ahli atau tetapan.

Jika butang tidak kelihatan, itu lazimnya sekatan role, status, sensitiviti atau tenant. Jangan cuba memintas melalui URL.

## 2. Log masuk

![Log masuk Ketua Imam](<imej/00-log-masuk.png>)
...
### 3.2 Laksanakan arahan minit

**Hasil akhir:** Tindakan sebenar selesai dan pengirim menerima status.

Ikuti gambar mengikut nombor. Jangan lompat ke gambar seterusnya sehingga langkah gambar semasa selesai.

#### Gambar 1: Pilih arahan

![Laksanakan arahan minit - Gambar 1](<imej/03-minit-saya.png>)

**Apa perlu dibuat pada Gambar 1**
1. Tapis Perlu Tindakan.
2. Baca arahan, keutamaan dan tarikh akhir.
...
![Laksanakan arahan minit - Gambar 2](<imej/rekod-butiran.png>)

**Apa perlu dibuat pada Gambar 2**
1. Semak rekod dan lampiran.
2. Jangan muat turun jika tidak diperlukan.

**Kemudian:** teruskan ke **Gambar 3: Balas dan edarkan minit**.


#### Gambar 3: Balas dan edarkan minit

![Laksanakan arahan minit - Gambar 3](<imej/minit-balas.png>)

**Apa perlu dibuat pada Gambar 3**
1. Edarkan susulan jika perlu.
2. Tulis catatan yang jelas.

**Kemudian:** teruskan ke **Gambar 4: Tanda tindakan minit selesai**.


#### Gambar 4: Tanda tindakan minit selesai

![Laksanakan arahan minit - Gambar 4](<imej/minit-selesai.png>)

**Apa perlu dibuat pada Gambar 4**
1. Selesaikan kerja sebenar.
2. Tanda selesai dan semak status.
...
2. Semak rekod dan lampiran.
3. Balas serta edarkan jika ada susulan.
4. Tanda selesai selepas tindakan sebenar lengkap.
