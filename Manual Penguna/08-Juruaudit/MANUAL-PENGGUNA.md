# Manual Pengguna Diwan - Juruaudit

**Versi UI disahkan:** 22 Julai 2026

**Tenant contoh:** MAM (data latihan, bukan production)

**Liputan Chrome:** 14/14 halaman, silang tenant HTTP 404, 8 skrin tindakan tambahan.

Manual ini khusus untuk role **Juruaudit**. Gambar menggunakan data latihan. Nama, e-mel, nombor telefon dan dokumen sebenar organisasi tidak patut dimasukkan ke manual.

## 1. Skop dan had role

**Tanggungjawab:** Akses semakan baca sahaja bagi rekod, fail, laporan dan log akses sensitif.

**Dibenarkan:** Rekod/fail yang dibenarkan, carian, kegemaran, laporan dan log audit.

**Had penting:** Tidak mencipta, mengubah, mengklasifikasi, memberi minit, membuat keputusan atau mentadbir tenant.

Jika butang tidak kelihatan, itu lazimnya sekatan role, status, sensitiviti atau tenant. Jangan cuba memintas melalui URL.

## 2. Log masuk

![Log masuk Juruaudit](<imej/00-log-masuk.png>)
...
### 3.2 Laksanakan semakan audit baca sahaja

**Hasil akhir:** Sampel rekod disemak tanpa mengubah bukti atau melangkaui akses.

Ikuti gambar mengikut nombor. Jangan lompat ke gambar seterusnya sehingga langkah gambar semasa selesai.

#### Gambar 1: Cari sampel audit

![Laksanakan semakan audit baca sahaja - Gambar 1](<imej/06-carian.png>)

**Apa perlu dibuat pada Gambar 1**
1. Gunakan metadata dan julat tarikh.
2. Simpan carian jika perlu.
3. Buka hanya hasil yang dibenarkan.

**Kemudian:** teruskan ke **Gambar 2: Hasil carian lanjutan**.


#### Gambar 2: Hasil carian lanjutan

![Laksanakan semakan audit baca sahaja - Gambar 2](<imej/carian-hasil.png>)

**Apa perlu dibuat pada Gambar 2**
1. Semak jumlah hasil.
2. Pilih sampel dan buka rekod.

**Kemudian:** teruskan ke **Gambar 3: Butiran rekod dan tindakan mengikut kebenaran**.


#### Gambar 3: Butiran rekod dan tindakan mengikut kebenaran

![Laksanakan semakan audit baca sahaja - Gambar 3](<imej/rekod-butiran.png>)

**Apa perlu dibuat pada Gambar 3**
1. Semak metadata, OCR, versi, minit, kelulusan dan audit.
2. Jangan gunakan sebarang kaedah untuk mengubah rekod.

**Kemudian:** teruskan ke **Gambar 4: Semak akses sensitif**.


#### Gambar 4: Semak akses sensitif

![Laksanakan semakan audit baca sahaja - Gambar 4](<imej/02-sensitive-access-logs.png>)

**Apa perlu dibuat pada Gambar 4**
1. Semak pengguna, tindakan, IP dan masa.
2. Bandingkan dengan skop audit.

**Kemudian:** teruskan ke **Gambar 5: Semak ringkasan**.


#### Gambar 5: Semak ringkasan

![Laksanakan semakan audit baca sahaja - Gambar 5](<imej/08-laporan.png>)

**Apa perlu dibuat pada Gambar 5**
1. Bandingkan jumlah rekod, retensi dan minit lewat.
2. Eksport hanya jika dibenarkan dan simpan secara terkawal.
...
| 4 | Minit Saya 1 | `/app/{tenant}/minit-saya` | 200 |
| 5 | Kelulusan | `/app/{tenant}/kelulusan` | 200 |
| 6 | Carian | `/app/{tenant}/carian` | 200 |
| 7 | Kegemaran | `/app/{tenant}/kegemaran` | 200 |
| 8 | Laporan | `/app/{tenant}/laporan` | 200 |
| 9 | Pembetulan Rekod | `/app/{tenant}/pembetulan-rekod` | 200 |
| 10 | Klasifikasi Fail | `/app/{tenant}/classification-nodes` | 200 |
| 11 | Rekod | `/app/{tenant}/records` | 200 |
| 12 | Fail | `/app/{tenant}/registry-files` | 200 |
...
![Minit Saya 1 - paparan 200](<imej/04-minit-saya.png>)
...
**Kawalan/tindakan yang terlihat semasa verifikasi:** `Masjid Al-Muttaqin Wangsa Melawati`, `Balas & Edarkan`.
...
![Kelulusan - paparan 200](<imej/05-kelulusan.png>)
...
![Carian - paparan 200](<imej/06-carian.png>)
...
![Kegemaran - paparan 200](<imej/07-kegemaran.png>)
...
![Laporan - paparan 200](<imej/08-laporan.png>)
...
![Pembetulan Rekod - paparan 200](<imej/09-pembetulan-rekod.png>)
...
![Klasifikasi Fail - paparan 200](<imej/10-classification-nodes.png>)
...
![Rekod - paparan 200](<imej/11-records.png>)
...
![Fail - paparan 200](<imej/12-registry-files.png>)
...
### 6. Butiran fail elektronik, fizikal atau hibrid
...
1. Gunakan carian/laporan untuk sampel.
2. Buka rekod/fail secara baca sahaja.
3. Semak metadata, versi, minit, kelulusan, pergerakan dan log sensitif.
4. Catat dapatan di luar sistem mengikut prosedur audit tanpa mengubah bukti.
