# Manual Pengguna Diwan - Nazir

**Versi UI disahkan:** 22 Julai 2026

**Tenant contoh:** MAM (data latihan, bukan production)

**Liputan Chrome:** 13/13 halaman, silang tenant HTTP 404, 11 skrin tindakan tambahan.

Manual ini khusus untuk role **Nazir**. Gambar menggunakan data latihan. Nama, e-mel, nombor telefon dan dokumen sebenar organisasi tidak patut dimasukkan ke manual.

## 1. Skop dan had role

**Tanggungjawab:** Menyemak rekod/fail, memberi atau menjawab minit dan membuat keputusan kelulusan yang ditujukan kepadanya.

**Dibenarkan:** Rekod, fail, minit dan keputusan kelulusan.

**Had penting:** Tidak mengklasifikasikan peti masuk, mengubah rekod, mengurus fail, storan, ahli atau tetapan.

Jika butang tidak kelihatan, itu lazimnya sekatan role, status, sensitiviti atau tenant. Jangan cuba memintas melalui URL.

## 2. Log masuk

![Log masuk Nazir](<imej/00-log-masuk.png>)
...
![Proses minit dan keputusan kelulusan - Gambar 1](<imej/03-minit-saya.png>)
...
![Proses minit dan keputusan kelulusan - Gambar 3](<imej/04-kelulusan.png>)
...
| 3 | Minit Saya 2 | `/app/{tenant}/minit-saya` | 200 |
| 4 | Kelulusan 3 | `/app/{tenant}/kelulusan` | 200 |
...
![Minit Saya 2 - paparan 200](<imej/03-minit-saya.png>)

**Nombor pada gambar**
1. Tajuk halaman Minit Saya 2.
...
![Kelulusan 3 - paparan 200](<imej/04-kelulusan.png>)

**Nombor pada gambar**
1. Tajuk halaman Kelulusan 3.
...
2. Semak rekod/media.
3. Balas minit atau buat keputusan kelulusan.
4. Sahkan tindakan direkod atas nama sendiri/delegasi.
