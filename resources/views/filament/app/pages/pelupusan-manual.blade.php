<x-filament-panels::page>
    {{-- F6-W0: sasaran spesifik menggantikan sorotan MAIN. Pada mobile 390×664, popover yang
         menyorot seluruh halaman menutup ruang tengah (defect `centerCovered`, RR-10-05). --}}
    <div data-help-target="disposal-warning"
        class="rounded-lg bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 p-4 text-sm text-red-700 dark:text-red-300">
    ...
    <x-filament::section class="mt-4">
        ...
        <p data-help-target="disposal-candidates">{{ $candidatesCount }} rekod telah cukup tempoh dan boleh dimasukkan ke batch pelupusan.</p>
    </x-filament::section>

    <x-filament::section>
        <x-slot name="heading">Batch Pelupusan</x-slot>
        <div data-help-target="disposal-batches">
            @if ($batches->isEmpty())
